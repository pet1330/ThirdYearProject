function resultanalysis = EnhancementEvaluation_Double_Density_Dual_Tree_Complex(currDir,ResultFolder,Imagfolder)
...
for r = 1:range
    ...
    Enh = doubledual_C2D(Img,T);        % denoise image using Double-Density Dual-Tree Complex DWT
    
    %Enhancement algorithm
    Enhancementalg = 'Double_Density_Dual_Tree_Complex';
