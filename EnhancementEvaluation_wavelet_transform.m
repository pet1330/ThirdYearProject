function resultanalysis = EnhancementEvaluation_wavelet_transform(currDir,ResultFolder,Imagfolder)
...
for r = 1:range
   ...
   Enh = denoisedemo('wavelet', Img);
    
    %Enhancement algorithm
    Enhancementalg = 'Wavelet_Transform';
