function resultanalysis = EnhancementEvaluation_Single_Scale_Retinex(currDir,ResultFolder,Imagfolder)
...
for r = 1:range
    ...
    Enh = single_scale_retinex(Img(:,:,2));
    
    %Enhancement algorithm
    Enhancementalg = 'Single_Scale_Retinex';
