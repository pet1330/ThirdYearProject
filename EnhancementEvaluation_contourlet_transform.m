function resultanalysis = EnhancementEvaluation_contourlet_transform(currDir,ResultFolder,Imagfolder)
...
for r = 1:range
   ...
   Enh = denoisedemo('contourlet', Img);
    
    %Enhancement algorithm
    Enhancementalg = 'Contourlet_Transform';
