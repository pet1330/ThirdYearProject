function resultanalysis = EnhancementEvaluation_Double_Density_Dual_Tree_Real(currDir,ResultFolder,Imagfolder)
...
for r = 1:range
    ...
    Enh = doubledual_R2D(Img,T);            % denoise image using Double-Density Dual-Tree Real DWT
