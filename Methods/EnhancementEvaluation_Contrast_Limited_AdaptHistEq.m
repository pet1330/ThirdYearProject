function resultanalysis = EnhancementEvaluation_Contrast_Limited_AdaptHistEq(currDir,ResultFolder,Imagfolder)
...
for r = 1:range
    ...
    Enhancementalg = 'Contrast_Limited_Adaptive_Histogram_Equalization';
