function resultanalysis = EnhancementEvaluation_Double_Density_Dual_Tree(currDir,ResultFolder,Imagfolder)
...
for r = 1:range
    ...
    Enh = double_S2D(Img,T);             % denoise the noisy image using Double-Density Dual-Tree DWT

    %Enhancement algorithm
    Enhancementalg = 'Double_Density_Dual_Tree';
