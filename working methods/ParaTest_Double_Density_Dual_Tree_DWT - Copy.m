...
for tests = 1:5
    allResults(:,:,1) = Default_Double_Density_Dual_Tree_DWT(currDir,ResultFolder,Imagfolder,ParaMin);
    allResults(:,:,2) = Default_Double_Density_Dual_Tree_DWT(currDir,ResultFolder,Imagfolder,ParaMid);
    allResults(:,:,3) = Default_Double_Density_Dual_Tree_DWT(currDir,ResultFolder,Imagfolder,ParaMax);
