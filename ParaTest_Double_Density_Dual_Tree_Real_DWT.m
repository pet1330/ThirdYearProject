...
for tests = 1:5
    ...
    bestMin = Default_Double_Density_Dual_Tree_Real_DWT(currDir,ResultFolder,Imagfolder,ParaMin);
    bestMid = Default_Double_Density_Dual_Tree_Real_DWT(currDir,ResultFolder,Imagfolder,ParaMid);
    bestMax = Default_Double_Density_Dual_Tree_Real_DWT(currDir,ResultFolder,Imagfolder,ParaMax);
